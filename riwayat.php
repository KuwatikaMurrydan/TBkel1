    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item" class="active">
        <a class="nav-link" href="riwayat.php">
          <i class="bi bi-gem"></i><span>Riwayat</span>
        </a>
      </li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">BERIKUT RIWAYAT MANIPULASI BARANG</h5>
              <!-- <button type="submit" style="background-color: #0d6efd; color: #ffffff; font-weight: bold; margin-left: 5px;"><a href="cetakpdf.php" style="text-decoration: none; color: inherit;">CETAK DATA</a></button> -->
              ...
              <div class="table-container">
                <table class="table datatable">
                  <thead>
                    ...
                    <th style="text-align: center;">Tindakan/Action</th>
