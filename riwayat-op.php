        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <button type="submit"
                style="background-color: #0d6efd; color: #ffffff; font-weight: bold; margin-left: 5px;"><a
                  href="cetakpdf.php" style="text-decoration: none; color: inherit;">CETAK DATA</a></button>
